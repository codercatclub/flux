...
var Button = function Button(_ref) {
  ...
  console.log('[D] text, buttonClass: ', text, buttonClass);
  var buttonClassName = buttonClass ? "".concat(_index_module_css__WEBPACK_IMPORTED_MODULE_1___default.a.button, " ").concat(_index_module_css__WEBPACK_IMPORTED_MODULE_1___default.a.buttonClassName) : _index_module_css__WEBPACK_IMPORTED_MODULE_1___default.a.button;
  return __jsx("div", {
    className: className,
    __source: {
...
var join = function join(email, questions, onSuccess, onFailure) {
...
var JoinForm = function JoinForm(_ref) {
  ...
  var whyProps = useInput('why', function () {
  ...
  var allInputsValid = areInputsValid([emailProps, whyProps, projectProps, socialProps]);
  ...
  return __jsx("div", {
    ...
    __self: this
  })), __jsx(_components_InputField__WEBPACK_IMPORTED_MODULE_4__["default"], Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, whyProps, {
    type: "text",
    ...
    __self: this
  })), __jsx(_components_InputField__WEBPACK_IMPORTED_MODULE_4__["default"], Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, projectProps, {
    type: "text",
    ...
    __self: this
  })), __jsx(_components_InputField__WEBPACK_IMPORTED_MODULE_4__["default"], Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, socialProps, {
    type: "text",
    ...
    onClick: function onClick() {
      return join(emailProps.value, [], handleSuccess, handleFailure);
    },
    __source: {
      fileName: _jsxFileName,
      lineNumber: 140
...
//# sourceMappingURL=index.js.8ec1746bd4674ba1d593.hot-update.js.map