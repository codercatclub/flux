...
var API_URL =  false ? undefined : 'http://localhost:9000/';
...
var join = function join(email, fields, onSuccess, onFailure) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_2___default.a.post("".concat(API_URL, "v1/subscribe"), {
    email: email,
    questions: questions
  }).then(function (res) {
    onSuccess(res);
...
var JoinForm = function JoinForm(_ref) {
  ...
  return __jsx("div", {
    ...
    className: _index_module_css__WEBPACK_IMPORTED_MODULE_7___default.a.successMessage,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 173
    },
...
//# sourceMappingURL=index.js.f99ae532af0fe3131f28.hot-update.js.map